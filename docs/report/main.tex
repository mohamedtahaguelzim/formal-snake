...
It says that the snake length is strictly positive and less that the total grid size $(W \times
H)$, the pending direction is valid, all snake positions are within the grid boundaries, the
snake has no duplicate positions and each segment of the snake is adjacent to the next segment.
